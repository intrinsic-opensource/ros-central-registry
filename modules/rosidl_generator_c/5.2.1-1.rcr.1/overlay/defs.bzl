...
load(":aspects.bzl", _rosidl_generator_c_aspect = "rosidl_generator_c_aspect")
load(":types.bzl", _RosCBindingsInfo = "RosCBindingsInfo")

# Types
RosCBindingsInfo = _RosCBindingsInfo
RosTypeDescriptionInfo = _RosTypeDescriptionInfo

# Aspects
rosidl_generator_c_aspect = _rosidl_generator_c_aspect
