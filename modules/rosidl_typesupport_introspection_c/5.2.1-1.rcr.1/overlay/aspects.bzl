...
def _rosidl_typesupport_introspection_c_aspect_impl(target, ctx):
    hdrs, srcs, include_dirs = generate_sources(
        ...
        input_templates_dir = ctx.attr._c_typesupport_introspection_templates[DefaultInfo].files.to_list()[0].dirname,
    ...
    # rosidl_typesupport_introspection_c_library is only needed for its
...
rosidl_typesupport_introspection_c_aspect = aspect(
    ...
    attrs = {
        ...
        "_c_deps": attr.label_list(
            default = [
                Label("@rosidl_typesupport_introspection_c//:rosidl_typesupport_introspection_c_library"),
            ],
            providers = [CcInfo],
        ),
        "_cc_shared_dep": attr.label(
            default = Label("@rosidl_typesupport_introspection_c//:rosidl_typesupport_introspection_c"),
        ),
    },
