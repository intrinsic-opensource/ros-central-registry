...
def _rosidl_typesupport_cpp_aspect_impl(target, ctx):
    hdrs, srcs, include_dirs = generate_sources(
        ...
        input_templates_dir = ctx.attr._cc_typesupport_templates[DefaultInfo].files.to_list()[0].dirname,
        templates_hdrs = [],
    ...
    # rosidl_typesupport_cpp_library (the static half of this package's own
...
rosidl_typesupport_cpp_aspect = aspect(
    ...
    attrs = {
        ...
        "_cc_shared_dep": attr.label(
            default = Label("@rosidl_typesupport_cpp//:transitive_dynamic_deps"),
        ),
    },
