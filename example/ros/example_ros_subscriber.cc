...
class ExampleRosSubscriber : public rclcpp::Node
{
public:
...
private:
  rclcpp::Subscription<example::msg::ExampleMessage>::SharedPtr subscription_;
};

int main(int argc, char * argv[])
{
  rclcpp::init(argc, argv);
  rclcpp::spin(std::make_shared<ExampleRosSubscriber>());
  rclcpp::shutdown();
  return 0;
}